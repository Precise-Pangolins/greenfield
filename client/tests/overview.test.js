...
//   getProdInfo,
//   getProdList
// } from '../../src/redux/actionCreators/overviewActions.js';
...
//       return expect(items.type).toBe('overview/FETCH_PRODUCT_LIST');
//     });
//   });
...
//       return expect(items.type).toBe('overview/FETCH_PRODUCT_STYLES');
//     });
//   });
...
//       return expect(items.type).toBe('overview/FETCH_PRODUCT_INFO');
//     });
//   });
// });
